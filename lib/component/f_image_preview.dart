...
class FImagePreview extends StatefulWidget {
  const FImagePreview({super.key});

  @override
  State<FImagePreview> createState() => _FImagePreviewState();
}

class _FImagePreviewState extends State<FImagePreview> {
                ...
                child: Center(
                  child: PhotoView(
                    ...
                    scaleStateChangedCallback: (state) {
                      // 当缩放状态改变时触发setState以更新_canDragToClose
                      setState(() {});
                    },
