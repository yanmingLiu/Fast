...
/// 对话框标签枚举
enum DialogTag { sigin, giftLoading, chatLevel }
...
class AppDialog {
  ...
  static Future<void> showChatLevel() async {
    // 注释掉的代码，保留为未实现状态
  ...
  static Future<void> showLoginReward() async {
    // 注释掉的代码，保留为未实现状态
  ...
  static Future<void> showGiftLoading() {
    return SmartDialog.show(
      clickMaskDismiss: false,
      keepSingle: true,
  ...
  static Future<void> hiddenGiftLoading() {
  ...
  static Future<void> showRateUs(String msg) async {
    return SmartDialog.show(
      clickMaskDismiss: false,
      builder: (_) {
